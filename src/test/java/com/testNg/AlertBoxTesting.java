...
public class AlertBoxTesting {
  ...
  public void WaitForPageLoad() {
	...
	/*
	 * public static String takeScreenshot(WebDriver driver, String name) throws
	 * Exception{
	 * 
	 * File Source=((TakesScreenshot) driver).getScreenshotAs(OutputType.FILE);
	 * String dateName=new SimpleDateFormat("YYYYMMddhhmmss").format(new Date());
	 * 
	 * System.out.println("dateName"); String
	 * destination=System.getProperty("user.dir")+
	 * "//src//test//resources//ScreenShots//" +dateName +name +"captured.png";
	 * FileUtils.copyFile(Source, new File(destination)); return destination;
	 * 
	 * }
	 */
}